...
export const MagneticButton = ({ children, className = "", onClick }: MagneticButtonProps) => {
  ...
  return (
    ...
    >
      ...
      <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-background px-8 py-3 text-sm font-medium text-foreground backdrop-blur-3xl transition-colors hover:bg-background/80">
        <motion.span
